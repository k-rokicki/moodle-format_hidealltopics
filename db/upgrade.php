...
/**
 * Upgrade scripts for Hide All Topics course format.
 *
...
/**
 * Upgrade script for Hide All Topics course format.
 *
 * @param int|float $oldversion the version we are upgrading from
 * @return bool result
 */
function xmldb_format_hidealltopics_upgrade($oldversion) {
    global $CFG, $DB;
