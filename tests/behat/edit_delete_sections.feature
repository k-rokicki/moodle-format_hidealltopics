@format @format_hidealltopics
Feature: Sections can be edited and deleted in Hide All Topics format
  ...
  @javascript
  Scenario: Inline edit section name in Hide All Topics format
  ...
  Scenario: Deleting the last section in Hide All Topics format
  ...
  Scenario: Deleting the middle section in Hide All Topics format
  ...
  @javascript
  Scenario: Adding sections in Hide All Topics format
